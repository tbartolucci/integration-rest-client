...
Prepare service:
```java
String apiUrl = "https://www.developer.yaypay.com/api/v1/"; //Provided from Yaypay team
String authorizationUrl = "qwertyuiop1234568" // Provided from Yaypay team
ApiService apiService = new ApiService(apiUrl,authorizationUrl);
```

Methods:
`apiKey` - unique key that you can receive from Yaypay team
```java
